...
categories.each do |category|
  if category == "Sports"
    ...
    Activity.create!(name: "Rock Climbing", image_url: "https://plus.unsplash.com/premium_photo-1672281090478-9b3ad329ad88?q=80&w=3205&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D", description: "Go indoor or outdoor climbing totether", location: cities[rand(0..cities.length)], user: User.all.sample, category: category, location: cities.sample)
    ...
    Activity.create!(name: "Stand up comedy", image_url: "https://images.unsplash.com/photo-1527261834078-9b37d35a4a32?q=80&w=3270&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D", description: "Go and see your favourite comedia together", location: cities[rand(0..cities.length)], user: User.all.sample, category: category, location: cities.sample)
    ...
    Activity.create!(name: "Pottery Class", image_url: "https://images.unsplash.com/photo-1607556671927-78a6605e290b?q=80&w=3270&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D", description: "Attend a pottery class tohether", location: cities[rand(0..cities.length)], user: User.all.sample, category: category, location: cities.sample)
    ...
    Activity.create!(name: "Paint Together", image_url: "https://images.unsplash.com/photo-1578961140619-896df05b1fd2?q=80&w=3270&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D", description: "Paint or attend a pianting class together", location: cities[rand(0..cities.length)], user: User.all.sample, category: category, location: cities.sample)
